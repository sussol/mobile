...
const data = {
  'Main Fridge': {
    ...
    temperatureExposure: '2.5℃ to 7.5',
    temperaturePoints: {
      maxLine: [
        { date: 'Feb 23', temp: 5 },
        { date: 'Feb 24', temp: 6 },
...
export class Location extends Realm.Object {
  ...
  getTemperaturePoints({ fromDate, toDate } = {}) {
  ...
  getCurrentTemperature() {
    console.log(this.description, Object.keys(data));
