...
export const modalStrings = new LocalizedStrings({
  gb: {
    ...
    delete_these_requisitions:
      'Are you sure you want to delete these requisitions?',
    delete_these_stocktakes:
      'Are you sure you want to delete these stocktakes?',
    delete: 'Delete',
    ...
    finalise_supplier_requisition:
      'Finalise will send this requisition and lock it permanently.',
    ...
    finalise_stocktake:
      'Finalise will adjust inventory and lock this stocktake permanently.',
    finalise_supplier_invoice:
      'Finalise will adjust inventory and lock this invoice permanently.',
    ...
    select_the_number_of_months_stock_required:
      'Select the number of months stock required',
    ...
    stock_quantity_greater_then_zero:
      'Stock quantity must be greater then zero before finalising',
    stocktake_no_counted_items:
      "Can't finalise a stocktake with no counted items",
  ...
  fr: {
    ...
    delete_these_requisitions:
      'Êtes-vous sûr de vouloir supprimer ces réquisitions ?',
    delete_these_stocktakes:
      "Êtes-vous sûr de vouloir supprimer ces relevé d'inventaires ?",
    delete: 'Supprimer',
    ...
    edit_the_stocktake_comment:
      "Modifier le commmentaire de ce relevé d'inventaire",
    edit_the_stocktake_name: "Modifier le nom de ce relevé d'inventaire:",
    finalise_customer_invoice:
      'Finaliser verrouillera cette facture de façon permanente.',
    finalise_supplier_requisition:
    ...
    select_the_number_of_months_stock_required:
      'Sélectionner le nombre de mois de stock requis',
    ...
    stocktake_no_counted_items:
      "Ne peut finaliser un relevé d'inventaire sans articles dénombrés",
    stocktake_invalid_stock:
      "Le stock disponible pour ces article(s) a changé depuis que ce relevé d'inventaire a été ouvert pour la dernière fois ( à cause de factures clients, factures de fournisseurs ou d'autres relevé d'inventaire). La quantité actuelle et celle de l'instantané seront réinitialisées.",
  },
  gil: {
    // TODO: add - edit_the_stocktake_comment, edit_the_stocktake_name, stocktake_invalid_stock
    add_at_least_one_item_before_finalising:
      'E riai n iai kanoana imwain ae ko finalise',
    and: 'ao',
    cancel: 'kamauna',
    confirm: 'kamatoa',
    ...
    finalise_customer_invoice:
      'Ko aki kona n manga bita te invoice ae a tia n Finalise',
    finalise_customer_requisition:
    ...
    finalise_supplier_requisition:
      'Am order ae Finalise, e nako, ao ko aki kona n bitia',
    finalise_stocktake: 'Am warebwai ae Finalise, ko aki manga kona n bitia',
    finalise_supplier_invoice:
      'Am karao-oota ae Finalise, ko aki manga kona n bitia',
    following_items_reduced_more_than_available_stock:
    ...
    stocktake_no_counted_items:
      'Ko aki kona n Finalise ngkana akea am warebwai',
  },
  tl: {
    // TODO: add - edit_the_stocktake_comment, edit_the_stocktake_name, stocktake_invalid_stock
    add_at_least_one_item_before_finalising:
      'Tenke hatama sasán ida antes finaliza',
    and: 'no',
    cancel: 'Kansela',
    confirm: 'Konfirma',
    create: 'Kria',
    ...
    delete_these_requisitions:
      "Ita sente tebes ita hakarak hapus rekuizisaun sira-ne'e?",
    delete_these_stocktakes:
      "Ita sente tebes ita hakarak hapus ajustamentu sira-ne'e?",
    delete: 'Apaga',
    ...
    finalise_supplier_requisition:
      "Finaliza sei labele edit rekuizasaun ne'eno xave permanente.",
    finalise_stocktake:
      "Finaliza sei ajusta inventariu no xave permanente Invoice ne'e.",
    finalise_supplier_invoice:
    ...
    start_typing_to_select_supplier:
      "Hakerek iha ne'e atu selekta distribuidor",
    stock_quantity_greater_then_zero:
      'Kuantidade Disponivel tenki bot liu Zero antes finaliza',
    stocktake_no_counted_items:
      'La bele finaliza ajustamentu se laiha item ida priense',
  },
});
