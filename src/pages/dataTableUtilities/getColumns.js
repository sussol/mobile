...
const PAGE_COLUMN_WIDTHS = {
  ...
  supplierInvoiceWithPrices: [2, 3.5, 2, 1.5, 1.5, 1.5, 1.5, 1],
  ...
  [ROUTES.STOCKTAKE_EDITOR]: [1, 2.6, 0.2, 1.2, 1.2, 1, 0.8],
  [ROUTES.STOCKTAKE_EDITOR_WITH_REASONS]: [1, 2.6, 0.2, 1.2, 1.2, 1, 1, 0.8],
  ...
  stocktakeBatchEditModal: [1, 2, 1, 1, 1, 1],
  stocktakeBatchEditModalWithReasons: [1, 2, 1, 1, 1, 1, 1],
  stocktakeBatchEditModalWithPrices: [1, 2, 1, 1, 1, 1, 1, 1],
  stocktakeBatchEditModalWithReasonsAndPrices: [1, 2, 1, 1, 1, 1.5, 1.5, 1.5, 1],
