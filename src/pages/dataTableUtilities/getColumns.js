...
const PAGE_COLUMN_WIDTHS = {
  ...
  [ROUTES.CUSTOMER_INVOICES_WITH_PROGRAMS]: [1.5, 2, 1.5, 2, 1.5, 3, 1],
  [ROUTES.CUSTOMER_REQUISITION]: [2, 4, 1.5, 1.5, 2, 2, 2, 2],
  [ROUTES.CUSTOMER_REQUISITIONS]: [1.5, 2, 1, 1, 1],
  [ROUTES.CUSTOMER_REQUISITIONS_WITH_PROGRAMS]: [1, 2, 2, 1, 1, 1],
  ...
  [ROUTES.SUPPLIER_INVOICES_WITH_PROGRAMS]: [1.5, 2, 1.5, 2, 1.5, 3, 1],
  ...
  [ROUTES.SUPPLIER_REQUISITIONS_WITH_PROGRAMS]: [1, 2, 2, 1, 1, 1, 1],
...
const PAGE_COLUMNS = {
  ...
  [ROUTES.CUSTOMER_INVOICES_WITH_PROGRAMS]: [
    COLUMN_NAMES.INVOICE_NUMBER,
    COLUMN_NAMES.CUSTOMER,
  ...
  [ROUTES.SUPPLIER_INVOICES_WITH_PROGRAMS]: [
    COLUMN_NAMES.INVOICE_NUMBER,
    COLUMN_NAMES.SUPPLIER,
    COLUMN_NAMES.PROGRAM,
    COLUMN_NAMES.ENTRY_DATE,
