...
export const BreachManUnhappy = ({ size }) => (
  <Svg
    width={size}
    height={size}
    viewBox="0 0 301 300"
  ...
  >
    ...
    <G fill="none" fillRule="evenodd">
      ...
      <G transform="translate(.469 27.273)">
        ...
        <G opacity={0.321} transform="translate(218.546 27.493)" fillRule="nonzero">
          <Ellipse fill="url(#prefix__g)" cx={13.416} cy={9.078} rx={8.385} ry={8.425} />
          <Path
        ...
        <G fillRule="nonzero">
          <G transform="rotate(20 71.002 403.935)">
            <Path d="M1.2 3.222h3.45v176.297a1.725 1.725 0 01-3.45 0V3.222z" fill="#D8D8D8" />
            <Path
            ...
            <Path
              ...
              fill="#FFF"
            />
            <Ellipse fill="#D8D8D8" cx={2.3} cy={2.312} rx={2.3} ry={2.312} />
          </G>
          <Path
