...
export const SortAscIcon = <FAIcon name="sort-asc" size={15} />;
export const SortNeutralIcon = <FAIcon name="sort" size={15} />;
export const SortDescIcon = <FAIcon name="sort-desc" size={15} />;
